                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                if ($userType == 'Super') {
                                    echo '<a href="add-course.php" class="btn btn-primary">+ Add new</a>';
                                }
                                ?>
                            </div>
                            <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-responsive-md">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql = "SELECT `id`, `name`, `crm_id` FROM `course` WHERE 1";
                                                            ...
                                                            if ($userType == 'Super') {
                                                                echo '
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <td>
													<div class="d-flex">
														<a href="course_edit.php?id=' . $row['id'] . '"" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-pencil"></i></a>
														<a href=" course_delete.php?id=' . $row['id'] . '"" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>
												</td>
