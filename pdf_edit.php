...
if(isset($_SESSION['user'])) { 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $update_query = "UPDATE pdf_files_extra SET file_name=?, description=?, course_id=? WHERE id=?";
        ...
        if ($update_result) {
            if (isset($_FILES['pdf_file'])) {
                ...
                if (is_uploaded_file($file_path)) {
                    ...
                    if (move_uploaded_file($file_path, $upload_directory . $random_file_name)) {
                        ...
                        $update_file_query = "UPDATE pdf_files_extra SET file_path=? WHERE id=?";
            ...
            header("Location: pdffiles.php"); // توجيه المستخدم إلى الصفحة الرئيسية بعد نجاح التحديث
            exit();
        } else {
    ...
    $query = "SELECT * FROM pdf_files_extra WHERE id = ?";
                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Edit PDF File</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input id="pdf_file" type="file" name="pdf_file" class="form-control" accept=".pdf">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
