...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = $conn->prepare("INSERT INTO msq (group_id, question, type) VALUES (?, ?, ?)");
    // قم بتغيير "is" إلى "iss" لمطابقة نوع البيانات في حقول الاستعلام
    $insert_query->bind_param("iss", $group_id, $question, $type);

    if ($insert_query->execute()) {
        // إذا تمت العملية بنجاح، قم بتحويل المستخدم إلى صفحة نجاح الإضافة
        header("Location: msq.php");
        exit;
    } else {
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="group_id" name="group_id" class="form-control" required="">
                                                    ...
                                                    if ($conn->connect_error) {
                                                       ...
                                                       $sql = "SELECT `id`, `name` FROM `rating_groups`";
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Question" id="question" name="question" type="text" class="form-control" required="">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
