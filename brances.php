                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                if ($userType == 'Super') {
                                    echo '<a href="add-branch.php" class="btn btn-primary">+ Add new</a>';
                                }
                                ?>
                            </div>
                            <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-responsive-md">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql = "SELECT `id`, `branch_name_ar`, `branch_name_en`, `branch_name_gr`, `mobile_number`, `type` FROM `branches` WHERE 1";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>" . $row['branch_name_ar'] . "</td>";
                                                            echo "<td>" . $row['branch_name_en'] . "</td>";
                                                            echo "<td>" . $row['branch_name_gr'] . "</td>";
                                                            echo "<td>" . $row['mobile_number'] . "</td>";
                                                            if ($row['type'] == 1) {
                                                                echo "<td><span class=\"badge light badge-success\">Whatsapp</span></td>";
                                                            } else {
                                                                echo "<td><span class=\"badge light badge-danger\">Phone</span></td>";
                                                            }
                                                            $userType = $_SESSION['user']['type'];
                                                            if ($userType == 'Super') {
                                                                echo '
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <td>
													<div class="d-flex">
														<a href="edit_branch.php?id=' . $row['id'] . '"" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-pencil"></i></a>
														<a href=" branch-delete.php?id=' . $row['id'] . '"" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>
												</td>
