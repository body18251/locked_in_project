...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $pdf_url = $_POST['pdf_url']; // احصل على عنوان URL لملف PDF
    ...
    // استخدم الرابط الذي أدخله المستخدم مباشرة في استعلام قاعدة البيانات
    $insert_query = $conn->prepare("INSERT INTO video_files_extra (course_id, file_name, description, file_path) VALUES (?, ?, ?, ?)");
    $insert_query->bind_param("isss", $course_id, $file_name, $description, $pdf_url);
                            ...
                            <div class="card-body">
                                <form action="" method="post" id="addBranchForm" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
        <div class="form-group">
            <label class="form-label" for="pdf_url">Video  URL</label>
            <input id="pdf_url" type="text" name="pdf_url" class="form-control" placeholder="Enter PDF file URL" required="">
        </div>
    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Video add confirm</h5>
