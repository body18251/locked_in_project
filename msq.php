        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">MSQ</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                if ($userType == 'Super') {
                                    echo '<a href="new_msq.php" class="btn btn-primary">+ Add new</a>';
                                }
                                ?>
                            </div>
                    <div class="col-lg-12">
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    if ($userType == 'Super') {
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="msq_edit.php?id=' . $row['id'] . '" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-pencil"></i></a>
                                                                <a href="msq_delete.php?id=' . $row['id'] . '" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </td>
                                                    ';
                                                    }
