...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['pdf_file'])) {
    ...
    if (is_uploaded_file($file_path)) {
        ...
        if (move_uploaded_file($file_path, $upload_directory . $random_file_name)) {
            ...
            $insert_query = $conn->prepare("INSERT INTO pdf_files_extra (course_id, file_name, description, file_path) VALUES (?, ?, ?, ?)");
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="pdf_file" type="file" name="pdf_file" class="form-control" accept=".pdf" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Pdf add confirm</h5>
