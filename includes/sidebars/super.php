        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="admins.php">All admins</a></li>
                            <li><a href="add-professor.php">Add admin</a></li>
                        </ul>
                    </li>
					<!-- <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    ...
                    <i class="fa-solid fa-sliders"></i>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="brances.php">Branches</a></li>
                 ...
                 <li class="nav-label">Rating</li>
                    ...
                    <i class="fa-solid fa-group-arrows-rotate"></i>
                                        							<span class="nav-text">MSQ Groups</span>
						</a> 
                     <ul aria-expanded="false">
                    ...
                    <li class="nav-label">Notfication</li>
                    <!-- <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    <i class="fa-solid fa-check"></i>
                                        							<span class="nav-text">Scheduled Notifications</span>
						</a> 
                     <ul aria-expanded="false">
                            <li><a href="rating_groups.php">All Notifications</a></li>
                            <li><a href="new_group_rating.php">Add Notifications</a></li>
</ul>
                            ...
                            <li><a class="ai-icon" href="send_notfication.php" aria-expanded="false">
                    ...
                    <li><a class="ai-icon" href="all_notfication.php" aria-expanded="false">
                    <i class="fa-solid fa-check-double"></i>
                            ...
                            <li class="nav-label">Extra files</li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    <i class="fa-regular fa-file-pdf"></i>
                    							<span class="nav-text">Pdf files</span>
						</a> 
                     <ul aria-expanded="false">
                            <li><a href="pdffiles.php">All files</a></li>
                            <li><a href="add-PDF.php">Add files</a></li>
</ul>
                            ...
                            <i class="fa-regular fa-file-video"></i>
                                                        							<span class="nav-text">Video files</span>
						</a> 
                     <ul aria-expanded="false">
                            <li><a href="video.php">All files</a></li>
                            <li><a href="add-video.php">Add files</a></li>
</ul>
                            ...
                            <i class="fa-regular fa-file-audio"></i>
                            							<span class="nav-text">Audio files</span>
						</a> 
                     <ul aria-expanded="false">
                            <li><a href="audiofiles.php">All files</a></li>
                            <li><a href="add-audio.php">Add files</a></li>
</ul>
				...
				<div class="copyright">
					...
					<p class="fs-12">Made with <span class="heart"></span> by O tech</p>
				</div>
            </div>
        </div>
        <!--**********************************
